...
It turns committed Git changes into a structured review draft, asks the agent to edit that draft in place, applies the review state, and opens a small local UI so a human can quickly inspect what changed and what the agent claimed.
